...
<html lang="en">
         ...
         <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8" style="display: flex; align-items: center; height: 100vh;justify-content: center;">
                  ...
                  <div class="card-body p-5">
                     ...
                     <form name="form" action="./login-forget-password.php" method="post" onsubmit="submission()">
                        ...
                        <button id="submit" class="login_button mt-1 mb-2 btn btn-primary w-100 rounded-1 py-2" type="submit">Reset Password</button>

                        <a href="./login.php" class="backlogin mt-2 btn btn-outline-dark w-100 rounded-2 py-2">Back to Login</a>
   ...
   <script>
      function submission() {
         ...
         document.querySelector('.backlogin').classList.add('d-none');
