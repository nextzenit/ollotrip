            ...
            <span class="bg-dark" style="height:4px">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="bg-light border rounded-4 p-3 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                        </div>
                    </div>
        ...
        <div class="col-md-2 mb-2">
            ...
            <span class="bg-primary" style="height:4px">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="col-md-5">
                    <div class="bg-light border rounded-4 p-3 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V9l-7-7z"/><path d="M13 3v6h6"/></svg>
                        </div>
                    </div>
        ...
        <div class="col-md-2 mb-2">
            ...
            <span class="bg-success" style="height:4px">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="col-md-5">
                    <div class="bg-light border rounded-4 p-3 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                        </div>
                    </div>
        ...
        <div class="col-md-3 mb-2">
            ...
            <span class="bg-danger" style="height:4px">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="col-md-3">
                        <div class="bg-light border rounded-4 py-3 text-center">
