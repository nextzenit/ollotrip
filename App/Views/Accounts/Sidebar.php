...
<div class="pt-3">
    <div class="sticky-top bg-white">
        <div class="author-content">
            <div class="lh-1 rounded p-3 py-4 mb-0 text-center align-items-center gap-3" style="">
...
<ul class="sidebar-menu list-items w-100 g-1 user_menu">
    ...
    <li class=""><a class="py-2
    <?php if (isset($meta['reports_active'])) { echo "active btn btn-primary w-100 d-block fadeout"; }else{ echo "btn btn-outline-dark w-100 d-block fadeout"; }?>" href="<?=root.('reports/'.date("Y"))?>">
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2H6a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V9l-7-7z"/><path d="M13 3v6h6"/></svg>
    <?=T::reports?></a>
    </li>
    <?php } ?>
