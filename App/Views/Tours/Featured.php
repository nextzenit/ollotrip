<div data-aos="fade-up" class="featured_tours container py-5 pt-0">
   <div class="featured_tours p-0 rounded-0 py-3">
     <div class="text-start">
     <h4 class="mt-1 mb-0"><strong><?=T::popular_tours?></strong></h4>
         ...
         <div class="col-lg-8 pe-lg-0">
            <div class="d-lg-flex list-group list-group-horizontal flex-wrap flex-lg-row feature--city flex-column">
               <?php
                  ...
                  $link = root.'tour'.'/'.$item->id.'/tours/'.date('d-m-Y').'/'.$item->adult.'/'.$item->child; ?>

               <a class="fadeout list-group-item list-group-item-action border-0 p-0" href="<?=$link?>">
         ...
         <div class="col-lg-4 mt-3 mt-lg-0">
            <div class="d-flex flex-column h-100">
               ...
               <div class="gap-3 align-items-center p-4 flex-column bg-light rounded-2 mt-4 h-100">
                  ...
                  <hr>
                  <a href="<?=root?>tours" class="fadeout d-block btn btn-dark px-3 border text-white py-3" style="font-weight: 600;"><?=T::view_more?></a>
               </div>
            </div>
         </div>
      </div>
