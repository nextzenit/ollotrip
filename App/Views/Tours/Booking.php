    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="form-content">
                        <div class="card-item shadow-none radius-none mb-0">
                            <div class="card-img pb-2">
                             <img class="lazyload" src="<?php if (isset($booking_data['tour_img'])){ echo $booking_data['tour_img']; } else { echo root."assets/img/hotel.jpg";} ?>" alt="img">
                            </div>
                ...
                <!-- <li class="lh-1 mt-0"><span><?=T::price?></span><?=currency?> <?= number_format( $booking_data['total_price'],2) ?></li>
                ...
                <strong class="col-6 d-flex align-items-center h4 m-0"><strong><small class="mx-2"><?=currency?></small></strong>
                    <input name="total_price" class="total" readonly type="text" value="<?= number_format( $booking_data['total_price'],2) ?>" style="background: transparent; border: 0; color: #fff;">
                </strong>
                ...
                <script>
                 ...
                 $("#agent_fee").on('keyup', function(event) {
                    ...
                    var total_val = parseFloat("<?= number_format( $booking_data['total_price'],2) ?>") || 0; // Default to 0 if not a valid number
