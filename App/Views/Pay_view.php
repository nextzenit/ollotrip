...
<div class="card">
    <div class="card-header">
      <small <?php if($_POST['payment_gateway'] == 'amazon'){echo 'style="display: none"';}?>><?=T::pay_with?> <strong><?= str_replace('-', ' ', ($_POST['payment_gateway']));?> <small><?=$payload->currency?></small> <?=number_format($payload->price,2)?></strong></small>
    </div>
    <div class="card-body">
      <?=$body?>
    </div>
