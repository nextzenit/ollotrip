   ...
   <div class="row mb-0 pt-1 g-2">
      <div class="col-lg-6">
            <div class="input-items">
                ...
                <select id="" name="city" class="origin cars_flights_origin form-control w-100" required>
                <?php if(isset($_SESSION['cars_flights_origin'])){ ?>
                <option value="<?=strtoupper($_SESSION['cars_flights_origin'])?>" selected><?=strtoupper($_SESSION['cars_flights_origin'])?></option>
                <?php } else {?>
      ...
      <!-- <div class="col-md-3">
         <div class="input-items">
            ...
            <select id="cars_city" name="city" class="cars_city form-control" required>
               <?php if(isset($_SESSION['cars_destination'])){ ?>
               <option value="<?=$_SESSION['cars_destination']; ?>">
                  <?=str_replace("-", " ", $_SESSION['cars_destination']); ?>
               </option>
               <?php } else { ?>
      ...
      <div class="col-lg-3">
         <div class="input-box">
            ...
            <div class="dropdown dropdown-contain">
                        ...
                        <div class="dropdown-menu dropdown-menu-wrap w-100 rounded-3 p-3">
...
$("#cars-search").submit(function() {
    ...
    // var from_airport = $('.cars_flights_origin').val();
    var from_airport = $(".cars_flights_origin option:selected").val().toLowerCase();
    var date = $('#date').val();
    var cars_adults = $('#cars_adults').val();
    var cars_child = $('#cars_child').val();
    var city_trims = from_airport.split(',').slice(0, 1).join(' ').split(' ').join('-').replace('%40', '@');

    // REMOVE - DASH FROM END OF THE CITY
    if(city_trims.slice(-1) == '-') { var city_ = city_trims.slice(0, -1);
    } else { var city_name = city_trims; }

    console.log(from_airport);

    if (from_airport == 'select city') {
    ...
    $('.loading_button').hide();
        ...
        var finelURL = './cars/'+from_airport+'/'+date+'/'+cars_adults+'/'+cars_child;
