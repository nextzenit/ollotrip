        ...
        $('.append_template').prepend(`
            <div class="card--item col-12 col-md-4 col-lg-3">
               <div class="card p-2 rounded-3">
                  ...
                  <span class="d-inline-block rounded-pill position-absolute" style="top:15px; right:15px; height: 10px;width: 10px;background: `+item.module_color+`"></span>
                  </div>
                  ...
                  <p class="card-text h5" data-price="${item.actual_price}"><strong><small><?=currency?></small> ${item.actual_price}</strong></p>
                   <form id="" class="" action="<?=root?>cars/booking"  method="post">
                   ...
                   <input type="hidden" name="date" value="<?=$meta['date']?>">
