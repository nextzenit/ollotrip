...
if (empty($meta['data'])) {
    ...
    <div class="position-relative container-fluid pt-4 pb-4">
        ...
        <div class="container">
            <div class="row g-3">
                ...
                <div class="col-lg-3 d-md-none d-lg-block">
                    ...
                    <div class="p-5 #load_hide d-none justify-content-center align-items-center" style="min-height:171.4px;display:flex"> <div class="loading_home"> <div class="bg-white"> </div> </div> </div>
                                    ...
                                    <div class="sidebar-widget-item">
                                        <div class="contact-form-action">
                                            ...
                                            <div class="sidebar-widget controls">
                                                ...
                                                <div class="sidebar-box mb-2 controls">
                                                        <p class="mt-3"><strong><?= T::oneway ?> <?= T::airlines ?></strong></p>

                                                        <ul class="list remove_duplication checkbox-group oneway--checkbox-filter" style="max-height: 300px; overflow: hidden; overflow-y: auto; margin-top: 18px;">
                                                            <?php
            ...
            <!-- right side  -->
            <div class="col-lg-9">
            <div class="new-m-main-tit__content flex1 mb-3" style="background: url('<?=root?>assets/img/flight_search.avif') center bottom -212px / cover, rgb(50, 100, 255);">
            ...
            <div class="flex tit-travel-restriction-wrapper">
                ...
                <nav class="#sticky-top uhf sorting" style="top:80px" id="data">
                    <ul class="flex-nowrap gap-3 flex-sm-wrap nav nav-pills nav-justified bg-white rounded-2 overflow-hidden mb-3">
                        <li class="nav-item">
                            <!-- <button data-sort="price:asc" role="button" class="nav-link border-end active rounded-0 px-0" data-bs-toggle="tab"> -->
                            <button data-value="asc" role="button" class="nav-link active rounded-2 px-0 border" data-bs-toggle="tab">
                        ...
                        <button data-value="desc" role="button" class="nav-link rounded-2 px-0 border" data-bs-toggle="tab">
                                <span class="d-block w-100 d-flex align-items-center justify-content-center gap-2">
                ...
                <div class="p-5 #load_hide d-none justify-content-center align-items-center" style="min-height:171.4px;display:flex">
                    ...
                    <ul id="flight--list-targets" class="list">
                        ...
                        // dd(json_encode($FLIGHTS_DATA));
                            ...
                            foreach ($item as $index => $segment) {
                                    ...
                                    $return_idex = key($item->segments[1]);
                                    } else { $return_route = ""; }
                                    ...
                                    $routes = $item;
                                    end($routes->segments[0]);
                                    $oneway_index = key($routes->segments[0]);
                                    // pre($routes);
                                ...
                                <li class="mix all card bg-white rounded-2 p-4 mt-2 flight_list
                                ...
                                <form class="" action="<?=root?>flight/booking" name="" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mt-3 mt-sm-0 col-md-6">
                                            <h6 class="mb-0"><strong>
                                                    ...
                                                    <?= date('h:i a', strtotime($segment[0][$oneway_index]->arrival_time)); ?>
                                                </strong></h6>
                                            <p class="mb-1"><?= $segment[0][0]->airline ?> - <small> <?= $segment[0][0]->flight_no ?> </small></p>

                                        </div>
                                        <div class="col-md-5">
                                            <div class="row trip-details text-end">

                                                <div class="col-6 col-md-6">
                                                    <p class="mb-0"><strong><?= T::flights_tripduration ?> </strong></p>
                                                    <p class="mb-0"> <?= $segment[0][0]->total_duration ?> <?= T::hours ?> </p>
                                                </div>

                                                <!-- FLIGHT STOPS -->
                                                <div class="col-6 col-md-6 text-end">
                                                    <p class="mb-0"><strong> <?= T::flights_stops ?>
                                                            <?php
                                                            // dd($index);
                                                            // if ($index == 0) {
                                ...
                                <?php if ($_SESSION['flights_type']=="return"){ ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mt-3 mt-sm-0 col-md-7">
                                                <h6 class="mb-0"><strong>
                                                        ...
                                                        -
                                                        <?= date('h:i a', strtotime($item->segments[1][$return_idex]->arrival_time)); ?>
                                                    </strong>
                                                </h6>
                                    ...
                                    <?php } ?>
                                                ...
                                                <div class="pt-2 px-0 d-flex flex-column flex-sm-row justify-content-between">
                                                    ...
                                                    <button
                                                        class="flex-grow-1 btn btn-outline-primary"
                                                        type="button"
                                                        ...
                                                        <button type="submit" class="flex-grow-1 btn btn-primary"><?= T::select ?> <?= T::flight ?></button>
                                                    </div>
                                                </div>
